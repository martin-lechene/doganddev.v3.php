<header>
        <div class="wrap">
            ...
            <nav>
                 ...
                 <a class="<?php    if($page == "services"){            echo("active");    }            else{        echo("");    }?>" href="/services.php">Services</a>
                 <a class="<?php    if($page == "portfolio"){           echo("active");    }            else{        echo("");    }?>" href="/portfolio.php">Portfolio</a>
